...
/// @fn  ImprimirResultados(float, float, float, float)
/// @brief Imprime los resultados en consola.
///
/// @param descuneto
/// @param interes
/// @param bitcoin
/// @param precioKm
void ImprimirResultados(float descuneto,float interes, float bitcoin, float precioKm);
#endif /* OBTENER_H_ */
